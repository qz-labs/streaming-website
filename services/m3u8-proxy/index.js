...
// httpUtils was missing from the original — define the user agent here
const httpUtils = {
...
app.get("/m3u8-proxy", async (req, res) => {
    ...
    try {
        ...
        if (url.pathname.endsWith(".m3u8") || targetResponse.headers.get('content-type')?.includes("mpegURL")) {
            ...
            // Covers VTT subtitles and any other text responses — must include CORS header
            // so the browser allows <track> elements loaded cross-port to render.
